    ...
    return (
        <>
            <form  className={style.contact + "  col-lg-11 col-xl-10 mt-4"}>
                <span className={style.title+ " row pb-3 mb-5 border-bottom mx-auto col-10 p-0 d-flex justify-content-center"}>
                    Feel Free to share Feedback or Suggestions about our Website
                </span>
